...
int main(){
	if(!bolaT.loadFromFile("./assets/imagenes/ball.png")){
		cout<<"Error al cargar textura Bol"<<endl;
	}
	
	if(!paletaT.loadFromFile("./assets/imagenes/paddle.png")){
		cout<<"Error al cargar textura Paleta"<<endl;
	}
	
	if(!fuente.loadFromFile("./assets/font/Minecraft.ttf")){
